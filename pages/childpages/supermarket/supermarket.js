// pages/childpages/supermarket/supermarket.js
...
Page({
  ...
  onLoad: function (options) {
	...
	wx.getStorage({
	  ...
	  success (res) {
			if(res.data){
				that.getAjaxRequest(supermarket.url+'?_jdrandom='+(new Date().getTime())+'&platCode=h5&appName=paidaojia&appVersion=7.4.5&functionId=channel%2FgetChannelDetail&body=%7B%22longitude%22:'+JSON.parse(res.data).lng+',%22latitude%22:'+JSON.parse(res.data).lat+',%22city%22:%22%E6%B7%B1%E5%9C%B3%E5%B8%82%22,%22address%22:%22%E6%B7%B1%E5%9C%B3%E5%B8%82%E8%BD%AF%E4%BB%B6%E4%BA%A7%E4%B8%9A%E5%9F%BA%E5%9C%B0%22,%22coordType%22:%222%22,%22channelId%22:%22'+options.id+'%22,%22ref%22:%22%2Fhtml%2Findex.html%22%7D&lng='+JSON.parse(res.data).lng+'&lat='+JSON.parse(res.data).lat+'&city_id=1607&jda='+supermarket.data.jda+'&poi='+supermarket.data.poi+'&signKey='+supermarket.data.signKey+'&traceId='+supermarket.data.traceId);	
				that.getNearShop(nearShopData.url+'?_jdrandom='+(new Date().getTime())+'&platCode=h5&appName=paidaojia&appVersion=7.4.5&functionId=zone%2FrecommendStoreList&body=%7B%22channelId%22:%22'+options.id+'%22,%22city%22:%22%E6%B7%B1%E5%9C%B3%E5%B8%82%22,%22longitude%22:'+JSON.parse(res.data).lng+',%22latitude%22:'+JSON.parse(res.data).lat+',%22currentPage%22:1,%22pageSize%22:10,%22rankType%22:0,%22filterTagIds%22:%22%22,%22lastStoreId%22:%22%22,%22coordType%22:%222%22,%22platform%22:%221%22%7D&lng='+JSON.parse(res.data).lng+'&lat='+JSON.parse(res.data).lat+'&city_id=1607&jda='+nearShopData.data.jda+'&poi='+nearShopData.data.poi+'&signKey=0ba368ef5b3b88a2dd2f86dfc45b16b0&traceId='+nearShopData.data.traceId);
			}
	  }
	});
  },
