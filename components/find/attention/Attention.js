// components/find/attention/Attention.js
...
Component({
  ...
  ready:function(){
  	  ...
  	  wx.getStorage({
  	    ...
  	    success (res) {
  	  		if(res.data){
  	  			that.getAjaxData(supermarket.url+'?_jdrandom='+(new Date().getTime())+'&platCode=h5&appName=paidaojia&appVersion=7.4.5&functionId=newFeed%2FcontentList&body=%7B%22longitude%22:'+JSON.parse(res.data).lng+',%22latitude%22:'+JSON.parse(res.data).lat+',%22cityId%22:1607,%22currentPage%22:1,%22careType%22:1,%22pageSize%22:21,%22tabType%22:%22feedTab%22%7D&lng='+JSON.parse(res.data).lng+'&lat='+JSON.parse(res.data).lat+'&city_id=1607&jda='+supermarket.data.jda+'&poi='+supermarket.data.poi+'&signKey=5276af6a092b1b38c76c775d9eea661d&traceId=H5_DEV_7D87288D-A7B8-4603-9E2E-1F209A9C38131584329455528');	
  			}
  	    }
  	  });
  }
